    ...
    <PageWrapper>
      <div className="pb-24 bg-bg overflow-hidden">
        ...
        <section className="pt-32 pb-12 px-6 max-w-4xl mx-auto text-center md:text-left relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[11px] font-semibold tracking-wide bg-surface border border-border uppercase text-content-muted mb-6 shadow-sm">
          ...
          <ScrollReveal>
            <div className="bg-surface border border-border rounded-2xl p-6 sm:p-8 lg:p-12 mb-16 shadow-sm relative overflow-hidden flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 group">
              ...
              <div className="max-w-2xl relative z-10">
                <span className="font-mono text-[11px] tracking-widest text-content-muted font-bold uppercase block mb-2">
              ...
              <div className="shrink-0 relative z-10">
                <CTAButton href={globalCTAs.primary.path} type="primary" className="w-full sm:w-auto">
                  Reserve a Time Slot <ArrowRight className="w-4 h-4 ml-2" />
                </CTAButton>
              </div>
            </div>
          </ScrollReveal>
            ...
            <div className="lg:col-span-7 space-y-4">
              <ScrollReveal>
                <div className="px-2 mb-2">
                  <h3 className="text-xs font-bold font-mono uppercase tracking-widest text-content-muted">
                ...
                <ScrollReveal key={idx} delay={idx * 0.1}>
                  <div className="bg-surface border border-border rounded-xl p-6 transition-all hover:border-primary/50 shadow-sm relative overflow-hidden">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <span className="shrink-0 font-mono text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-md border border-border bg-bg-secondary text-content-muted">
                        {channel.badge}
                      </span>
                    </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-border flex items-center justify-between">
                      <a
                        ...
                        className="font-mono text-xs text-ink dark:text-white font-bold hover:text-primary transition-colors flex items-center gap-1.5 group/link"
                      >
                        <span>{channel.actionText}</span>
                        <ArrowRight className="w-3.5 h-3.5 text-content-muted transition-transform group-hover/link:translate-x-0.5 group-hover/link:text-primary" />
                      </a>
                    </div>
                  </div>
                </ScrollReveal>
                ...
                <div className="bg-surface border border-border rounded-xl p-6 space-y-6 shadow-sm">
                  {responseMetrics.map((metric, idx) => (
                    ...
                    >
                      ...
                      <span className="font-mono text-sm font-extrabold text-ink dark:text-white bg-bg-secondary px-2.5 py-1 rounded-md border border-border">
                        {metric.value}
                      </span>
                    </div>
                  ))}
                  ...
                  <div className="bg-bg-secondary rounded-xl p-4 border border-border flex items-center gap-3">
                    ...
                    <p className="text-[11px] text-content-secondary font-mono leading-normal">
                      We actively monitor all channels during business hours to ensure fast, reliable support for our clients.
                    </p>
                  </div>
                </div>

                <div className="p-4 rounded-xl border border-dashed border-border text-[11px] text-content-muted leading-relaxed text-center lg:text-left">
